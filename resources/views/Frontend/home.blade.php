...
<html>
    ...
    <main>
        ...
        <div class="watch-area section-padding30">
            <div class="container">
                ...
                <!-- <section> -->
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/adidas.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/facebook.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/google.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/instagram.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/nike.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/twitter.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/uber.png" alt="logo"></div>
                    <div class="slide"><img src="{{ asset('frontend') }}/partners/images/youtube.png" alt="logo"></div>
                </section>
            </div>
        <div>
    ...
    <!-- footer -->
    <link rel="stylesheet" href="{{ asset('frontend') }}/partners/styles.css">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>                  
    ...
    <script src="{{ asset('frontend') }}/ashion/js/main.js"></script>
