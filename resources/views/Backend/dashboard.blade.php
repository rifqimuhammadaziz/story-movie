...
<html lang="en">
  <head>
    <!-- Required meta tags -->
        ...
        <!-- plugins:css -->
        <link rel="stylesheet" href="{{ asset('backend') }}/admin/assets/vendors/mdi/css/materialdesignicons.min.css">
        <link rel="stylesheet" href="{{ asset('backend') }}/admin/assets/vendors/css/vendor.bundle.base.css">
        <!-- endinject -->
        <!-- Plugin css for this page -->
        <link rel="stylesheet" href="{{ asset('backend') }}/admin/assets/vendors/jvectormap/jquery-jvectormap.css">
        <link rel="stylesheet" href="{{ asset('backend') }}/admin/assets/vendors/flag-icon-css/css/flag-icon.min.css">
        <link rel="stylesheet" href="{{ asset('backend') }}/admin/assets/vendors/owl-carousel-2/owl.carousel.min.css">
        <link rel="stylesheet" href="{{ asset('backend') }}/admin/assets/vendors/owl-carousel-2/owl.theme.default.min.css">
        ...
        <!-- End layout styles -->
        <link rel="shortcut icon" href="{{ asset('backend') }}/admin/assets/images/favicon.png" />
  </head>
  <body>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{ asset('backend') }}/admin/assets/images/faces/face4.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{ asset('backend') }}/admin/assets/images/faces/face15.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">p</p>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img src="{{ asset('backend') }}/admin/assets/images/faces/face1.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{ asset('backend') }}/admin/assets/images/faces/face2.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{ asset('backend') }}/admin/assets/images/faces/face5.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{ asset('backend') }}/admin/assets/images/faces/face3.jpg" alt="image" />
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{ asset('backend') }}/admin/assets/images/faces/face4.jpg" alt="image" />
